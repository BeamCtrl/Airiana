...
sudo -E apt-get -yq --allow-downgrades --allow-remove-essential --allow-change-held-packages -o "Dpkg::Options::=--force-confdef" -o "Dpkg::Options::=--force-confnew" upgrade
...
sudo -E apt-get -yq upgrade --download-only
sudo -E apt-get -yq  --allow-downgrades --allow-remove-essential --allow-change-held-packages -o "Dpkg::Options::=--force-confdef" -o "Dpkg::Options::=--force-confnew" dist-upgrade
sudo -E apt-get update --fix-missing
